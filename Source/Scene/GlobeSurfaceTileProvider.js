...
function createTileUniformMap(frameState, globeSurfaceTileProvider) {
  const uniformMap = {
    ...
    //add by zmf begin 将uniform变量加入uniformmap
    u_dayTextureInvert: function () {
      return this.properties.dayTextureInvert;
    },
    u_dayTextureGrayscale: function () {
      return this.properties.dayTextureGrayscale;
    },
    u_dayTextureSepia: function () {
      return this.properties.dayTextureSepia;
    },
    //add by zmf end
...
const surfaceShaderSetOptionsScratch = {
  ...
  applyHue: undefined,
  //add by zmf begin
  applyInvert: undefined,
  applyGrayscale: undefined,
  applySepia: undefined,
  //add by zmf end
...
function addDrawCommandsForTile(tileProvider, tile, frameState) {
  ...
  do {
    ...
    while (numberOfDayTextures < maxTextures && imageryIndex < imageryLen) {
      ...
      //add by zmf begin 传入options中的值，令applyInvert为真
      uniformMapProperties.dayTextureInvert[numberOfDayTextures] =
        imageryLayer.invert;
      applyInvert =
        applyInvert ||
        uniformMapProperties.dayTextureInvert[numberOfDayTextures] !==
          ImageryLayer.DEFAULT_INVERT;
      //add by zmf end

      //add by zmf begin 传入options中的值，令applyGrayscale为真
      uniformMapProperties.dayTextureGrayscale[numberOfDayTextures] =
        imageryLayer.grayscale;
      applyGrayscale =
        applyGrayscale ||
        uniformMapProperties.dayTextureGrayscale[numberOfDayTextures] !==
      ...
      //add by zmf begin 传入options中的值，令applySepia为真
      uniformMapProperties.dayTextureSepia[numberOfDayTextures] =
        imageryLayer.sepia;
      applySepia =
        applySepia ||
        uniformMapProperties.dayTextureSepia[numberOfDayTextures] !==
          ImageryLayer.DEFAULT_SEPIA;
      //add by zmf end

      //add by zmf begin 传入options中的滤镜顺序
      filterIndex=imageryLayer.filterIndex;
      //add by zmf end
    ...
    //add by zmf begin
    surfaceShaderSetOptions.applyInvert = applyInvert;
    surfaceShaderSetOptions.applyGrayscale = applyGrayscale;
    surfaceShaderSetOptions.applySepia = applySepia;
    surfaceShaderSetOptions.filterIndex = filterIndex;
    //add by zmf end
